...
{
/*******************************************************************************
  old/original register commands for SSD1306 chip
*******************************************************************************/
...
/*******************************************************************************
  NEW register commands for SSD1306 chip
*******************************************************************************/
  // OLED_WriteReg(0xfd);//--turn off oled panel
  // OLED_WriteReg(0x12);//--turn off oled panel
  // OLED_WriteReg(0xae);//--turn off oled panel

  // OLED_WriteReg(0x15);    //set column address
  // OLED_WriteReg(0x00);    //start column   0
  // OLED_WriteReg(0x7f);    //end column   127 <---- FLAG ARENT WE TWICE AS BIG?

  // OLED_WriteReg(0x75);    //set row address
  // OLED_WriteReg(0x00);    //start row   0
  // OLED_WriteReg(0x3f);    //end row   127

  // OLED_WriteReg(0x81);    //set contrast control
  // OLED_WriteReg(0x2f);

  // OLED_WriteReg(0xa0);    //gment remap
  // OLED_WriteReg(0xc3);    //51
  ...
  // OLED_WriteReg(0xab);    //set phase leghth
  // OLED_WriteReg(0x01);

  // OLED_WriteReg(0xad);    //set dclk
  // OLED_WriteReg(0x8e);    //80Hz:0xc1 90Hz:0xe1   100Hz:0x00   110Hz:0x30 120Hz:0x50   130Hz:0x70     01

  // OLED_WriteReg(0xb1);    //
  // OLED_WriteReg(0x22);    //

  // OLED_WriteReg(0xb3);    //set phase leghth
  // OLED_WriteReg(0xa0);
